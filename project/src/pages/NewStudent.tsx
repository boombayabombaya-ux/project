              ...
              <tbody className="divide-y divide-gray-200 bg-white/50">
                {students.map((student) => (
                  <tr key={student.id} className="hover:bg-blue-50/50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-800">{student.id || 'N/A'}</td>
                    <td className="px-4 py-3 text-sm text-gray-800">{student.fname} {student.mname} {student.lname}</td>
